...
func At(birthDate time.Time, now time.Time) int {
...
// Age is shorthand for At(birthDate, time.Now()), and carries the same usage and limitations.
func Age(birthDate time.Time) int {
	return At(birthDate, time.Now())
}
